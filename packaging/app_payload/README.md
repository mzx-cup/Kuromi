...
| 文档 | 说明 |
|------|------|
| [DEPLOYMENT.md](DEPLOYMENT.md) | **生产环境部署**（Nginx / Systemd / Docker） |
| [RUNNING_GUIDE.md](RUNNING_GUIDE.md) | 上手指南与功能介绍 |
| [PROJECT_MAP.md](PROJECT_MAP.md) | 功能 → 代码完整地图 |
| [PROJECT_STRUCTURE.md](PROJECT_STRUCTURE.md) | 项目结构说明 |
| [CODE_WIKI.md](CODE_WIKI.md) | 代码百科 |
| [SLICE_STATUS.md](SLICE_STATUS.md) | 各模块进度状态 |
