...
| 文档 | 说明 |
|------|------|
| [15-生产部署.md](15-生产部署.md) | **生产环境部署**（Nginx / Systemd / Docker） |
| [11-上手指南.md](11-上手指南.md) | 上手指南与功能介绍 |
| [12-功能代码地图.md](12-功能代码地图.md) | 功能 → 代码完整地图 |
| [13-项目结构说明.md](13-项目结构说明.md) | 项目结构说明 |
| [14-代码百科.md](14-代码百科.md) | 代码百科 |
| [16-切片进度.md](16-切片进度.md) | 各模块进度状态 |
| [sql/README.md](sql/README.md) | SQL 初始化脚本说明 |
...
详见 [15-生产部署.md 第 4 节](15-生产部署.md#四数据库初始化详解) 与 [sql/README.md](sql/README.md)。
...
# 5. Nginx 反向代理（详见 15-生产部署.md §3.9）
```

完整步骤见 [15-生产部署.md](15-生产部署.md)。
...
完整列表见 [15-生产部署.md 附录 A](15-生产部署.md#十附录环境变量清单)。
...
更多：[15-生产部署.md §9 常见问题排查](15-生产部署.md#九常见问题排查)
